...
class Test(unittest.TestCase):
    def test_common_assertion_methods(self):
        ...
        self.assertEqual(1, 1, 'there has been a disturbance in force')

        # Compare any two objects using the assertNonEqual method.
        # A method version of the != operator.
        ...
        # Check the identity if an object using assertIs.
        ...
        # Check if an object is a specific instance if a class using the assertIsInstance.
        ...
        # Check if an object is not a specific instance if a class using the assertNotIsInstance.
        ...
        # This assert is abit difference from the others, in that a callable is passed as an argument.
