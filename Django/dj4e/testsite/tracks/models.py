...
class Album(models.Model):
    ...
    # on_delete : if the artist get deleted whether the corresponding Album get deleted
    # null : allowing this field to be empty / an album without an artist
...
class Track(models.Model):
    ...
    def __str__(self):
        # when an object is created and printed, title will be printed
        # obj.album.artist - the way to access the album artist
        return self.title
